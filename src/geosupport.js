...
geosupport.geocode.address = function (address, fields) {
  /*
    Geocodes an address
    Address: JS object w/ the following fields: [HouseNumber, BorroughCode, StreetName / AltStreetName, ZipCode]
    Fields: Array of additional data fields to append to the object
  */
